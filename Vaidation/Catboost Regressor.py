...
cb = CatBoostRegressor(
        iterations=493, # [100, 500] step of 1
        learning_rate=0.09, # [0.01, 0.3] step of 0.01
        depth=1, # [1, 10] step of 1
        l2_leaf_reg=2, # [1, 10] step of 1
        random_state=42
)
...
last_step_length = float(prompt_user_input("Enter last step length: "))
...
cm_lowering = float(prompt_user_input("Enter CM lowering: "))
...
second_last_step_flight_time = float(prompt_user_input("Enter 2nd last step flight time: "))
take_off_angle = float(prompt_user_input("Enter take off angle: "))
...
thigh_angular_velocity_of_swing_leg_at_to= float(prompt_user_input("Enter Thigh angular velocity of swing leg at TO: "))
...
data = {
    ...
    'last step length': [last_step_length],
    ...
    '2nd Last step flight time (s)': [second_last_step_flight_time],
    'Take of angle': [take_off_angle],
    ...
    'Thigh angular velocity of swing leg at TO': [thigh_angular_velocity_of_swing_leg_at_to]
}
...
# Predict on new data
new_predictions = cb.predict(new_data)
